...
void CustomModel_EditTitleScreenLogo(void* titleScreenZAR) {
    ...
    EDIT_BYTE(0x5E580, 0x29);
    EDIT_BYTE(0x5E581, 0x5C);
    EDIT_BYTE(0x5E582, 0x0F);
    EDIT_BYTE(0x5E583, 0x3F); // Red to 0.56

    EDIT_BYTE(0x5E660, 0x01);
    EDIT_BYTE(0x5E670, 0xCF);
    EDIT_BYTE(0x5E671, 0xF7);
    EDIT_BYTE(0x5E672, 0x53);
    EDIT_BYTE(0x5E673, 0x3E); // Green 0.207

    EDIT_BYTE(0x5E750, 0x01);
    EDIT_BYTE(0x5E760, 0x48);
    EDIT_BYTE(0x5E761, 0xE1);
    EDIT_BYTE(0x5E762, 0x3A);
    EDIT_BYTE(0x5E763, 0x3F); // Blue 0.73
    
    // g_title_fire_ura.cmab
    EDIT_BYTE(0x5EA80, 0x01);
    EDIT_BYTE(0x5EA90, 0x29);
    EDIT_BYTE(0x5E581, 0x5C);
    EDIT_BYTE(0x5E582, 0x0F);
    EDIT_BYTE(0x5E583, 0x3F); // Red to 0.56
    
    EDIT_BYTE(0x5EB70, 0x01);
    EDIT_BYTE(0x5EB80, 0xCF);
    EDIT_BYTE(0x5EB81, 0xF7);
    EDIT_BYTE(0x5EB82, 0x53);
    EDIT_BYTE(0x5EB83, 0x3E); // Green 0.207

    EDIT_BYTE(0x5EC60, 0x01);
    EDIT_BYTE(0x5EC70, 0x48);
    EDIT_BYTE(0x5EC71, 0xE1);
    EDIT_BYTE(0x5EC72, 0x3A);
    EDIT_BYTE(0x5EC73, 0x3F); // Blue 0.73
}
