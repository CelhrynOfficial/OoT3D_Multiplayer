...
#---------------------------------------------------------------------------------
APP_TITLE       :=  Ocarina of Time 3D Multiplayer
APP_AUTHOR      :=  Celhryn & Estuko
APP_DESCRIPTION :=  Connect with your friends
...
export OUTPUT	:=	C:/Users/timot/Documents/Rangement/Emulation/3DS/Games/$(TARGET)
