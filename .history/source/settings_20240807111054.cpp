...
Option MP_Enabled        = Option::U8  ("Multiplayer",     {"On", "On (Local)"}, {mp_EnabledDesc});
Option MP_SharedProgress = Option::Bool("Shared Progress", {"Off", "On"},         {mp_SharedProgressDesc});
Option MP_SyncId         = Option::U8  (2, "Sync ID",      {NumOpts(1, 1)},       {mp_SyncIdDesc}, OptionCategory::Cosmetic);
